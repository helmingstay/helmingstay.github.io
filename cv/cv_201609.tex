...
\address{(706)~224-7627 \\ http://www.x14n.org \\ research@x14n.org} % Your phone number and email
...
%\begin{itemize}
\item My research employs a dynamical systems interpretation of population and
community ecology, with a focus on discrete, stochastic systems and processes. I
use empirical data, numerical simulations, and modern statistical methods to
...
human perturbations, and demographic founder events such
as colonization and development of resistance. My study systems include 
childhood diseases in the pre-vaccine era U.S.\, and mosquito population 
