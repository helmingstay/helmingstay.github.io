...
%\begin{itemize}
\item 
My research explores the ecological determinants of 
real-world population dynamics. I use empirical data, numerical
...
partially observed Markov processes, and population
...
\item My core areas of expertise include: 
mechanistic ecological simulation models;
stochastic processes; data visualization;
numerical programming;
time series spectral analysis;
and linear and generalized linear modeling.
I am also interested in automated data acquisition and 
remote sensing. I employ a range of open
source computing tools: the R and
C++ programming languages; PostgreSQL and SQLite database 
systems; and the geospatial tools PostGIS and QGIS.
I employ reproducible research tools and
best practices, including revision control with git.

\item  I enjoy teaching and mentoring 
students from diverse backgrounds and experience levels. 
My teaching and mentorship focuses on quantitative skills,
where I favor real-world examples and student-led inquiry. 
I believe that rigorous quantitative training is critical for next
generation of data-driven scientists. I aim
